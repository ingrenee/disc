...
<link href="<?PHP echo $path;?>css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
<link href="<?PHP echo $path;?>css/plugins/timeline/timeline.css" rel="stylesheet">
...
<div id="wrapper">
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
				...
				<ul class="nav navbar-top-links navbar-right">
						<li class="dropdown" style="display:none;"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-envelope fa-fw"></i> <i class="fa fa-caret-down"></i> </a>
						...
						<!-- /.dropdown -->
						<li class="dropdown" style="display:none;"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-tasks fa-fw"></i> <i class="fa fa-caret-down"></i> </a>
						...
						<!-- /.dropdown -->
						<li class="dropdown" style="display:none;"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-bell fa-fw"></i> <i class="fa fa-caret-down"></i> </a>
				...
				<div class="navbar-default navbar-static-side" role="navigation">
						<div class="sidebar-collapse">
								<ul class="nav" id="side-menu">
										...
										<li> <a href="<?PHP echo ci_site_url('');?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a> </li>
...
<script src="<?PHP echo $path;?>js/sb-admin.js"></script> 

<!-- Page-Level Demo Scripts - Dashboard - Use for reference --> 
<script src="<?PHP echo $path;?>js/demo/dashboard-demo.js"></script>
